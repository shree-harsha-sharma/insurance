        ...
        <div class="mx-auto p-4 col-lg-7">
          <h1 class="mb-4">Your details</h1>
            ...
            <div class="form-group">
                ...
                <asp:TextBox class="form-control" placeholder="Subject" type="text" ID="pwd" ReadOnly="true" runat="server"></asp:TextBox>
        ...
        <div class="mx-auto p-4 col-lg-7">
          <h1 class="mb-4">Your policy details</h1>
            ...
            <div class="form-group">
                ...
                <asp:TextBox class="form-control" placeholder="Subject" type="text" ID="term" ReadOnly="true" runat="server"></asp:TextBox>
