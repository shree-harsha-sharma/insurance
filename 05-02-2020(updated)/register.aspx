...
<body>
    ...
    <div class="container"> <a class="navbar-brand" href="homepage.aspx">
        ...
        <div class="mx-auto col-lg-6 col-10">
          ...
          <form class="text-left" runat="server" id="form1">
            <div class="form-group">
              ...
              <div class="form-group">
                <asp:Label ID="userage" for="userage" runat="server" Text="Your age"></asp:Label>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="uage" ErrorMessage="RequiredFieldValidator" ForeColor="Red">user age required</asp:RequiredFieldValidator>
                <asp:TextBox ID="uage" type="text" runat="server" class="form-control" placeholder="25"></asp:TextBox>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <asp:Label ID="address" for="address" runat="server" Text="Your Address"></asp:Label>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="add" ErrorMessage="RequiredFieldValidator" ForeColor="Red">user address required</asp:RequiredFieldValidator>
                <asp:TextBox ID="add" type="text" runat="server" class="form-control" placeholder="new york"></asp:TextBox>
