...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 order-2 order-lg-1 p-0"> <img class="img-fluid d-block" src="admin.png" height="600px"> </div>
        <div class="mx-auto col-md-6 col-10 bg-white p-5">
          <h1 class="mb-4">Admin Log in...</h1>
          <form id="form1" runat="server">
            <div class="form-group">
                <asp:TextBox type="text" placeholder="Enter admin id" class="form-control" ID="username" runat="server"></asp:TextBox>
