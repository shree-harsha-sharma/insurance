...
<body>
  ...
  <li class="nav-item size">
     <a class="nav-link" href="policyhome.html"><b>Buy Policy
      </b>
  ...
  <li class="nav-item size">
        ...
        <div class="mx-auto p-4 col-md-7">
          <h1 class="mb-4">Report the problem</h1>
            ...
            <div class="form-group"> 
                <asp:TextBox  ID="policy_no" type="text" placeholder="Enter policy no" class="form-control" runat="server"></asp:TextBox>
               </div>
            
              <div class="form-group">
                  <asp:Label ID="Label1" for="exampleFormControlSelect1" runat="server" class="select" Text="Select the Issue"></asp:Label>
   ...
   <!-- <select class="form-control" runat="server" id="select">
      ...
      <option value="5">5</option>
            ...
            <div class="form-group">
                <textarea ID="textarea" runat="server" class="form-control" cols="20" rows="4" placeholder="Problem discription"></textarea>
                </div> 
            <asp:Button ID="Button1" type="button" runat="server" class="btn btn-success" Text="Send" OnClick="Button1_Click" />
           <br />
          
            <asp:Label ID="lblmsg" runat="server" class="message" ForeColor="#00CC00"></asp:Label>
            <br />
