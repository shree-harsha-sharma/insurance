...
<div class="row">
  ...
  <img class="card-img-top" src="issue.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">customer complaints</h5>
    <p class="card-text"></p>
    <a href="adminissue.aspx" class="btn btn-primary">customer complaints</a>
  </div>
</div>

         <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="customer.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">customers</h5>
    <p class="card-text"></p>
    <a href="customerdetails.aspx" class="btn btn-primary">customer details</a>
  </div>
</div>
    </div>
