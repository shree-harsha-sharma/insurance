...
<body>
  ...
  <li class="nav-item size">
          ...
          <h1 class="mb-4 text-dark">Endowment Policy </h1>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox2" class="form-control" type="text"  placeholder="muturity" ReadOnly="true" runat="server" TextMode="Number"></asp:TextBox>
                 ...
                 <div class="form-group">
                     <asp:Button type="submit" class="btn btn-primary" ID="Button2" runat="server" Text="Buy Policy" OnClick="Button2_Click" />
   ...
   <div class="py-3 text-center" id="show" runat="server">
    <div class="container">
      <div class="row">
        <div class="mx-auto p-4 col-lg-7">
          <h1 class="mb-4">claimant details</h1>
             <div class="form-row">
              <div class="form-group col-md-6">
                  <asp:Label ID="cname" runat="server" Text=""><b class="font-weight-bold">claimant name</b></asp:Label>
                  <asp:TextBox type="text" ID="c_name" class="form-control"  runat="server"></asp:TextBox>
                  

              </div>
              <div class="form-group col-md-6"> 
                  <asp:Label ID="Label8" runat="server" Text=""><b class="font-weight-bold">address</b></asp:Label>
                  <asp:TextBox ID="c_address" type="Text" class="form-control"  runat="server"></asp:TextBox>
             ...
             <div class="form-row">
              <div class="form-group col-md-6">
                  <asp:Label ID="Label9" runat="server" Text=""><b class="font-weight-bold">age</b></asp:Label>
                  <asp:TextBox type="text" ID="c_age" class="form-control"   runat="server"></asp:TextBox>
                  

              </div>
              <div class="form-group col-md-6"> 
                  <asp:Label ID="Label10" runat="server" Text=""><b class="font-weight-bold">phone number</b></asp:Label>
                  <asp:TextBox ID="c_phn" type="Text" class="form-control"  runat="server"></asp:TextBox>
                 <br />
                   <div class="form-group col-md-6">
                     <asp:Button type="submit" class="btn btn-primary" ID="claimant" runat="server" Text="Add claimant" OnClick="claimant_Click"  />
