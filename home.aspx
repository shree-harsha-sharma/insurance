...
<body>
    ...
    <div class="container"> <i class="fa fa-handshake-o" style="font-size:36px;color:white"></i><a class="navbar-brand" href="#">&nbsp;<b>LIFE INSURANCE</b>
      </a> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar10">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbar10">
        <ul class="navbar-nav ml-auto">
          <a class="btn navbar-btn ml-md-2 btn-light text-dark">USER LOGIN</a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-interval="1000" style="height:50%;">
      <img src="sample1.jpg" class="d-block w-100" alt="..." width="100%" height="650px">
    </div>
    <div class="carousel-item" data-interval="1000">
      <img src="sample2.jpg" class="d-block w-100" alt="..."width="100%" height="650px">
    </div>
    <div class="carousel-item">
      <img src="sample3.jpg" class="d-block w-100" alt="..."width="100%" height="650px">
    </div>
  </div>
...
<div class="py-5" >
    <div class="container">
      ...
      <div class="row d-flex justify-content-between">
        <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="term.png" width="1500">
        ...
        <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="endowment.png" width="1500">
        ...
        <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="money.png" width="1500">
          <h4 class="my-3"> <b>Money back plans</b> </h4>
          <p>The money-back policy from Life Insurance Corporation in India is a popular insurance policy. It provides life coverage during the term of the policy and the maturity benefits are paid in installments.</p>
		  <button type="button" class="btn btn-outline-primary">Know more</button>
        </div>
      </div>
    </div>
